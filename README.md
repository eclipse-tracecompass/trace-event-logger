...
(In addition to the examples below, also see under root folder `lrucacheexample` for an example that generates interesting traces, inspired by a real-life investigation about the performance of an application's cache.)
