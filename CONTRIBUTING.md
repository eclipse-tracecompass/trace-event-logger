...
```
Make logger write to CTF #132

Since Trace Compass supports CTF, make the logger write directly
to that, it will be faster to write, and take less disk space.

Fixes https://github.com/eclipse-tracecompass/trace-event-logger/issues/132 
```
